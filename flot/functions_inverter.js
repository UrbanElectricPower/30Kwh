	...
	for (name in foo[0])
		{
			if (stuff_to_omit.indexOf(name) == -1)
			{
				...
				{
					$("#sd_"+name+"_iac").text(foo[0][name]["iac"])
					$("#sd_"+name+"_idc").text(Math.round(foo[0][name]["idc"]))
					$("#sd_"+name+"_piac").text(foo[0][name]["piac"])
					$("#sd_"+name+"_poac").text(Math.round(foo[0][name]["poac"]))
					$("#sd_"+name+"_soc").text(Math.round(foo[0][name]["soc"]))
					$("#sd_"+name+"_tpiac").text(Math.round(foo[0][name]["tpiac"]))
					$("#sd_"+name+"_tpoac").text(Math.round(foo[0][name]["tpoac"]))
					$("#sd_"+name+"_vac").text(Math.round(foo[0][name]["vac"]))
					$("#sd_"+name+"_vdc").text(Math.round(foo[0][name]["vdc"]))
				}			
			}
	}
